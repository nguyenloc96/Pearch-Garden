    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-xs-12">
                    ...
                    <ul class="accordion-ul">
                        <li class="accordion-title-chil">
                            ...
                            <ul class="accordion-ul">
                                <li class="accordion-content">
                                    ...
                                    <small>※年齢確認書類をご提出後に、ご登録いただいている生年月日を変更したい場合には、<a href="/sign-in"> お問い合わせ </a> より正しい生年月日をお送りください。</small>
                                </li>
                            </ul>
                        </li>
                        <li class="accordion-title-chil">
                            ...
                            <ul class="accordion-ul">
                                <li  class="accordion-content">
                                    <p>
                                        Web版のpatersの決済方法は、クレジットカードのみとなります。
                                    </p>
                                </li>
                            </ul>
                        </li>
                        <li class="accordion-title-chil">
                            ...
                            <ul class="accordion-ul">
                                <li  class="accordion-content">
                                    ...
                                    <small>※年齢確認書類をご提出後に、ご登録いただいている生年月日を変更したい場合には、<a href="/webpages/contact">お問い合わせ</a>より正しい生年月日をお送りください。</small>
                                </li>
                            </ul>
                        </li>
                        <li class="accordion-title-chil">
                        ...
                        <li class="accordion-title-chil">
                            ...
                            <ul class="accordion-ul">
                                <li class="accordion-content">
                                    <p>
                                        退会をご希望の方は、恐れ入りますが「マイページ」→「設定」→「お問い合わせ」よりお問い合わせカテゴリにて「退会」をお選びいただきお問い合わせください。<br>また、退会後は30日間再登録ができませんのでお気をつけください。<strong><a href="/webpages/privatemode">プライベートモード設定</a></strong>よりプライベートモードにすることでお相手の検索結果に表示されず、足あともつくことがありませんので、プライベートモード設定にされることをお勧めいたします。<br>
                                        patersを退会する際には、下記項目にご注意くださいませ。
                                    </p>
                                    <p>
                        ...
                        <li class="accordion-title-chil">
                            ...
                            <ul class="accordion-ul">
                                <li  class="accordion-content">
                                    <p>
                                        patersを退会されますと、30日間再登録ができませんので予めご了承くださいませ。<br>
                        ...
                        <li class="accordion-title-chil">
                            ...
                            <ul class="accordion-ul">
                                <li  class="accordion-content">
                                    <p>
                                        patersでは、複数のアカウントを持つことは禁止とされております。<br>
                    ...
                    <ul class="accordion-ul">
                        <li class="accordion-title-chil">
                            ...
                            <ul class="accordion-ul">
                                <li  class="accordion-content">
                                    <p>
                                        patersでは、会員の皆様にとって安心で安全なサービスを提供するために以下のような取り組みを行っております。
                        ...
                        <li class="accordion-title-chil">
                            ...
                            <ul class="accordion-ul">
                                <li  class="accordion-content">
                                    <p>
                                        patersは24時間365日、常時監視体制を敷いて会員の皆様に安心・安全なサービスをお届けいたします。<br>
                ...
                <div class="card">
                    <span class="accordion-title">paters サポートガイドライン</span>
                    <ul class="accordion-ul">
                        <li class="accordion-title-chil">
                            ...
                            <ul class="accordion-ul">
                                <li  class="accordion-content">
                                    <p>
                                        patersではメッセージ1通目でのLINE ID・カカオトークID・その他連絡先の交換を禁止しており、発見次第強制退会処分を行っております。<br />
                                        二通目以降のやりとりで連絡先を交換することは利用規約違反ではありませんが、お会いする前の連絡先交換は非推奨です。お相手が信用できる方だとわかるまで、個人情報のやりとりは行わないでください。
                                    </p>
                                    <p>
                                        ようにpaters外で起こったトラブルは運営事務局での事実確認が困難なため、paters運営事務局によるサポートとペナルティ付与の対象外になる場合がございます。
                                    </p>
                                    <ul class="list-ul">
                                        <li>個人連絡先交換後連絡が途絶えた</li>
                                        <li>LINE・カカオなどの外部連絡先で攻撃的なメッセージを受け取った</li>
                                        <li>他サービス(SNS、メッセージアプリ、paters以外のマッチングサービスを含む)でのやりとり中、patersの利用規約に違反する行為が見受けられた　等</li>
                                    </ul>
                                    <p>
                                        トラブル発生時の迅速な対応と平等な事実確認のために、paters内部でやりとりをしていただくようお願い申し上げます。
                                    </p>
                                </li>
                            </ul>
                        </li>
                        <li class="accordion-title-chil">
                            ...
                            <ul class="accordion-ul">
                                <li  class="accordion-content">
                                    <p>
                                        patersでは、お客様から寄せられた違反報告などについて公平に事実確認を行なっております。原則として、事実確認完了後に厳重注意・強制退会などのペナルティ付与を行ないます。
                                    </p>
                                    <p>
                                        以下のように、事実確認が難しいケースに関してはpaters運営事務局でトラブルの解決ができない可能性がございます。
                                    </p>
                                    <ul class="list-ul">
                        ...
                        <li class="accordion-title-chil">
                            ...
                            <ul class="accordion-ul">
                                <li  class="accordion-content">
                                    <p>
                                        patersでは、お客様からのご連絡に基づきユーザーに対して厳重注意、強制退会などのペナルティ付与を行う場合がございます。
                                    </p>
                                    <p>
                        ...
                        <li class="accordion-title-chil">
                            ...
                            <ul class="accordion-ul">
                                <li  class="accordion-content">
                                    ...
                                    <p>
                                        patersでは十分にご対応できないトラブルに関しても、警察署、弁護士、その他第三者機関へご相談いただくことでご協力できる場合がございます。
                                    </p>
                                    <p>
                                        patersは、警視庁主導の「インターネット異性紹介事業者登録」を完了しており、トラブルがあった際に警視庁との連携が可能でございます。<br />
                                        警視庁から正式に個人情報開示請求が届き次第、patersでお預かりしているお客様の情報を提供する準備が整っております。ご不安なことなどがある場合は、最寄りの警察署までご相談くださいませ。
                                    </p>
                                    <p>
                                        なお、paters内での会話のやりとりなどは、運営事務局にて全て保管しております。警察の捜査に協力する運びとなった際など、patersでの会話が重要な証拠になる場合もございますので、可能なかぎりpatersでのメッセージのやりとりをお願いいたします。
                                    </p>
                                </li>
                            </ul>
                        </li>
                ...
                <div class="card">
                    <span class="accordion-title">patersの機能について</span>
                    <ul class="accordion-ul">
                        <li class="accordion-title-chil">
                        ...
                        <li class="accordion-title-chil">
                            ...
                            <ul class="accordion-ul">
                                <li class="accordion-content">
                                    <p>
                                        お送り頂いたメッセージや画像にpaters運営事務局が不適切だと判断した内容が含まれている場合、メッセージは審査時に否認され、お相手に届くことはありません。
                                    </p>
                                </li>
                            </ul>
                        </li>
                        <li class="accordion-title-chil">
                            ...
                            <ul class="accordion-ul">
                                <li class="accordion-content">
                                    ...
                                    <p>
                                        1 通目の審査に関しましてはpaters利用規約で禁じられている行為について再度ご確認ください。
                                    </p>
                                    ...
                                    <p>
                                        patersにて絵文字を使うことは出来ません。文字化けやエラーの原因と成りますのでご利用はお控えください。
                                    </p>
                        ...
                        <li class="accordion-title-chil">
                            ...
                            <ul class="accordion-ul">
                                <li class="accordion-content">
                                    ...
                                    <p>
                                        patersポイントを使用することで「いいね！」を入手できます。<br>
                                        patersポイント【1pt = 「いいね！」1回】と交換することが可能です。<br>
                                        patersポイントがなくなってしまった場合は購入することができます。<br>
                                    ...
                                    <p>
                                        ...
                                        patersポイントを使用することで「いいね！」を入手することができ、
                                        patersポイント【1pt = 「いいね！」1回】と交換することが可能です。<br>
                                        有料会員のみなさまへ、ご登録から30日毎にpatersポイント「50pt」を付与させていただきます。<br>
                                        また、patersポイントがなくなってしまった場合は購入することができます。
                                    </p>

                                    <p><strong>男性（プレミアム会員）</strong></p>
                                    <p>
                                        初回、アプリへの登録時に100いいね！を付与させていただきます。<br>
                                        また、プレミアム会員のお客様は、毎月patersポイント「200pt」を付与させていただきます。
                                        patersポイントを使用することで「いいね！」を入手することができ、
                                        patersポイント【1pt = 「いいね！」1回】と交換することが可能です。<br>
                                        また、patersポイントがなくなってしまった場合は購入することも可能です。<br>
                        ...
                        <li class="accordion-title-chil">
                            <span class="accordion-title-sub-chil"> 月が変わったのに残「patersポイント」が増えません（プレミアム会員）</span>
                            <ul class="accordion-ul">
                                <li class="accordion-content">
                                    <p>
                                       残「patersポイント」は、プレミアム会員へのご登録から30日毎に与えられ、毎月1日に付与されるわけではございません。
                                    </p>
                                </li>
                            </ul>
                        </li>
                        ...
                        <li class="accordion-title-chil">
                            ...
                            <ul class="accordion-ul">
                                <li class="accordion-content">
                                    ...
                                    <p>
                                        24時間経過しても審査が完了しない場合には、お手数ですがpaters運営事務局までお問い合わせください。
                                    </p>
                                </li>
                            </ul>
                        </li>
                        ...
                        <li class="accordion-title-chil">
                            ...
                            <ul class="accordion-ul" style="display: block;">
                                <li class="accordion-content">
                                    ...
                                    <p>
                                        万が一、24時間経過しても審査が完了しない場合には、お手数ですがpaters運営事務局までお問い合わせください。
                                    </p>
                                </li>
                            </ul>
                        </li>
                    ...
                    <ul class="accordion-ul">
                        <li class="accordion-title-chil">
                            ...
                            <ul class="accordion-ul">
                                <li  class="accordion-content">
                                    <p>
                                        女性会員様はpatersの基本的な機能を全て無料でご利用いいただけます。<br>
                                    </p>
                                </li>
                            </ul>
                        </li>
                        ...
                        <li class="accordion-title-chil">
                            ...
                            <ul class="accordion-ul">
                                <li class="accordion-content">
                                    ...
                                    <p>
                                        patersを利用していることを知られたくないお相手を見つけた場合、プロフィール画面右上にあるボタンをタップします。
                                    </p>
                    ...
                    <ul class="accordion-ul">
                            ...
                            <ul class="accordion-ul">
                                <li class="accordion-content">
                                    <p>
                                        ...
                                        また、退会後は30日間再登録ができません。<strong><a href="/webpages/privatemode">プライベートモード設定</a></strong>よりプライベートモードにすることでお相手の検索結果に表示されず、足あともつくことがありませんので、プライベートモード設定にされることをお勧めいたします。<br>
                                        patersを退会する際には、下記項目にご注意くださいませ。
                                    </p>
                        ...
                        <li class="accordion-title-chil">
                            ...
                            <ul class="accordion-ul">
                                <li class="accordion-content">
                                    <p>
                                        patersをご退会されますと、一定期間は再登録頂けません。<br>
                        ...
                        <li class="accordion-title-chil">
                            ...
                            <ul class="accordion-ul">
                                <li class="accordion-content">
                                    <p>
                                        退会後は 30 日間再登録ができません。<strong><a href="/webpages/privatemode">プライベートモード設定</a></strong>よりプライベートモードにすることでお相手の検索結果に表示されず、足あともつくことがありませんので、プライベートモード設定にされることをお勧めいたします。
                                    </p>
                                </li>
                            </ul>
                        </li>
                    ...
                    <ul class="accordion-ul">
                        ...
                        <li class="accordion-title-chil">
                            ...
                            <ul class="accordion-ul">
                                <li class="accordion-content">
                                    <p>
                                        実際に会ってみたら、プロフィールの写真と全く違う人物だった場合にはpaters運営事務局へのご通報のご協力をお願いいたします。<br>
                        ...
                        <li class="accordion-title-chil">
                            ...
                            <ul class="accordion-ul">
                                <li class="accordion-content">
                                    <p>
                                       18歳未満、または高校生でご登録されているユーザーを見つけた際には、違反報告よりpaters運営事務局へのご通報のご協力をお願いいたします。<br>
                                        ご通報をいただいた内容に関しましては、弊社にて確認の上、迅速に対応いたします。
                                    </p>
                                </li>
                            </ul>
                        ...
                        <li class="accordion-title-chil">
                            ...
                            <ul class="accordion-ul">
                                <li class="accordion-content">
                                    <p>
                                        下記のようなビジネス勧誘業者を見つけた際には、paters運営事務局へのご通報のご協力をお願いいたします。<br>
                                        ご通報をいただいた内容に関しましては、弊社にて確認の上、迅速に対応いたします。
                                    </p>
                                    <ul class="list-ul">
                        ...
                        <li class="accordion-title-chil">
                            ...
                            <ul class="accordion-ul">
                                <li class="accordion-content">
                                    <p>
                                        メッセージの1通目で他サービスのIDを送受信するユーザーを見つけた際には、違反報告よりpaters運営事務局へのご通報のご協力をお願いいたします。<br>
                                        ご通報をいただいた内容に関しましては、弊社にて確認の上、迅速に対応いたします。
                                    </p>
                                </li>
                            </ul>
                        ...
                        <li class="accordion-title-chil">
                            ...
                            <ul class="accordion-ul">
                                <li class="accordion-content">
                                    <p>
                                        paters内でやり取りをしているお相手が｢不審だ｣と感じた場合、ご通報のご協力をお願いいたします。patersでは365日24時間体制を敷いて監視対応しており業者･違反者対策には万全を期しておりますが、会員の皆様の通報等のご協力が必要と考えております。<br>
                    ...
                    <ul class="accordion-ul">
                        ...
                        <li class="accordion-title-chil">
                            ...
                            <ul class="accordion-ul">
                                <li class="accordion-content">
                                    <p>
                                        patersでは、24時間お客様からのお問い合わせ・ご相談を受け付けております。ヘルプ（よくある質問）をご覧いただき、解決に至らない場合には以下の手順にてお気軽にお問い合わせください。
                                    </p>
                                    <ol>
                                        <li>「マイページ」より「設定」を選択</li>
                                        <li>サポート内の「<a href="/webpages/contact">お問い合わせ</a>」からお問い合わせフォームにご記入・送信ください</li>
                                    </ol>
                                </li>
                            </ul>
                        </li>
                    ...
                    <ul class="accordion-ul">
                        <li class="accordion-title-chil">
                            ...
                            <ul class="accordion-ul" style="display: block;">
                                <li class="accordion-content">
                                    <p>
                                        patersでは、24時間お客様からのお問い合わせ・ご相談を受け付けております。ヘルプ（よくある質問）をご覧いただき、解決に至らない場合には以下の手順にてお気軽にお問い合わせください。<br>場合によりご回答までに少々お時間をいただく場合もございます。予めご了承くださいませ。<br>また、お問い合わせの際にはメールアドレスのお間違いにお気をつけください。
                                    </p>
                                    <ol>
                                        <li>「マイページ」より「設定」を選択</li>
                                        <li>サポート内の「<a href="/webpages/contact">お問い合わせ</a>」からお問い合わせフォームにご記入・送信ください</li>
