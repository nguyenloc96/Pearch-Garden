    ...
    <div class="container">
        <div class="row justify-content-center text-center">
            <div class="col-lg-12">
                ...
                <p class="text-muted mt-4 title-subtitle mx-auto">Sweet Honeys(ペイターズ)では、すべての会員の皆様が心から安心してアプリを利用いただくために、様々な取り組みを行っております。これらの取り組みは日々アップデートされており、ここに紹介されているのはその一部にしか過ぎません。</p>
            </div>
        </div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6">
                        <div class="works works-description-right">
                            ...
                            <p class="timeline-subtitle">Sweet Honeysでは、ユーザー様のすべての投稿（プロフィール画像、自己紹介文等）について、投稿時に事前審査を行い、不適切な書き込みがないことを24時間365日の監視体制で確認し、トラブルになることを未然に防ぎます。</p>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    <div class="col-lg-6 col-lg-pull-6">
                        <div class="works works-description-left">
                            ...
                            <p class="timeline-subtitle">Sweet Honeysでは、法令遵守を第一とした上で法令に基づき「インターネット異性紹介事業」の届出を東京都公安委員会に行っており、受理されております（受理番号：3017-0048-000）。各都道府県の警察および行政機関とも連携を図っており、トラブルが起きたときでも迅速に対応できる体制を整えております。</p>
                        </div>
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6">
                        <div class="works works-description-right">
                            ...
                            <p class="timeline-subtitle">Sweet Honeysでは、個人情報保護方針の策定をはじめ、アプリ内におけるすべてのデータ通信において最高峰レベルのセキュリティ「EV SSL」を採用する等、セキュリティの強化を日々努め、安全性の向上を行っております。</p>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="container">
        <div class="row justify-content-center text-center">
            <div class="col-lg-12">
                ...
                <p class="text-muted mt-4 title-subtitle mx-auto">Sweet Honeysでは、そのアプリの特長から様々なメディアからの取材実績が豊富です。</p>
            </div>
        </div>
        <div class="row mt-5">
